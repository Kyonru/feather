...
export type TokyoNightThemeId =
  ...
  | 'tokyo-night'
  | 'tokyo-night-storm';
export type RainglowThemeId =
  | 'rainglow-absent-contrast'
  | 'rainglow-absent'
  | 'rainglow-absent-light'
  | 'rainglow-chocolate-light'
  | 'rainglow-codecourse-contrast'
  | 'rainglow-friction-light'
  | 'rainglow-github-contrast'
  | 'rainglow-glowfish-contrast'
  | 'rainglow-glowfish'
  | 'rainglow-grunge-contrast'
  | 'rainglow-hawaii-contrast'
  | 'rainglow-hawaii'
  | 'rainglow-hawaii-light'
  | 'rainglow-heroku-contrast'
  | 'rainglow-heroku'
  | 'rainglow-heroku-light'
  | 'rainglow-hive-contrast'
  | 'rainglow-hive'
  | 'rainglow-hive-light'
  | 'rainglow-horizon-contrast'
  | 'rainglow-horizon'
  | 'rainglow-horizon-light'
  | 'rainglow-hub-contrast'
  | 'rainglow-hub'
  | 'rainglow-hyrule-contrast'
  | 'rainglow-hyrule'
  | 'rainglow-hyrule-light'
  | 'rainglow-iceberg-contrast'
  | 'rainglow-iceberg'
  | 'rainglow-iceberg-light'
  | 'rainglow-isotope-contrast'
  | 'rainglow-isotope'
  | 'rainglow-keen-light'
  | 'rainglow-lavender-light'
  | 'rainglow-prime-contrast'
  | 'rainglow-prime'
  | 'rainglow-rebellion-contrast'
  | 'rainglow-rebellion'
  | 'rainglow-rebellion-light'
  | 'rainglow-shrek-light'
  | 'rainglow-slime'
  | 'rainglow-stealth-contrast'
  | 'rainglow-stealth'
  | 'rainglow-stealth-light'
  | 'rainglow-tickle'
  | 'rainglow-vision-colorblind'
  | 'rainglow-vision-light-colorblind'
  | 'rainglow-yitzchok-contrast'
  | 'rainglow-yitzchok-light'
  | 'rainglow-yule-light'
  | 'rainglow-zacks';
