...
import { DownloadIcon, PauseIcon, PlayIcon, RotateCcwIcon, SearchIcon } from 'lucide-react';
...
export function ProfilerPanel() {
  ...
  }, [tableData, search, minTotalMs, minAvgMs, sortBy]);
  ...
  return (
    <div className="grid gap-4">
      ...
      <div className="grid gap-2 rounded-md border p-3 lg:grid-cols-[minmax(16rem,1fr)_12rem_10rem_10rem]">
