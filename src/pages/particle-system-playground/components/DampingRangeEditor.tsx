  ...
  return (
    <div className="grid gap-2">
      ...
      >
        ...
        {/* Min curve */}
        <path d={minPath} fill="none" stroke="var(--chart-1)" strokeWidth={1.5} strokeOpacity={0.6} strokeLinecap="round" />

        {/* Max curve */}
        <path d={maxPath} fill="none" stroke="var(--chart-1)" strokeWidth={1.5} strokeDasharray="4 3" strokeOpacity={0.9} strokeLinecap="round" />

        {/* Axis labels */}
        <text x={PAD.left} y={PAD.top - 1} fontSize={8} fill="currentColor" fillOpacity={0.35}>1.0</text>
        <text x={PAD.left} y={PAD.top + innerH * 0.5 + 3} fontSize={8} fill="currentColor" fillOpacity={0.25}>0.5</text>
        <text x={svgW - PAD.right - 6} y={PAD.top + 8} fontSize={8} fill="currentColor" fillOpacity={0.25}>t</text>
        <text x={PAD.left} y={H - 2} fontSize={8} fill="currentColor" fillOpacity={0.25}>velocity decay</text>
      </svg>
