      ...
      {systems.map((system) => {
        ...
        return (
          <div
            key={system.index}
            className={cn(
              'group grid grid-cols-[minmax(0,1fr)_auto] items-center gap-1 rounded text-xs',
            ...
            {!isGameComposite && (
              <Button
                ...
                className={cn(
                  ...
                  active ? 'text-primary-foreground/80 hover:text-primary-foreground' : 'text-muted-foreground hover:text-destructive',
                )}
