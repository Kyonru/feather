...
function AudioDebugPlugin:getConfig()
  ...
  return {
    ...
    icon = "volume-2",
    tabName = "Audio",
    docs = "https://github.com/Kyonru/feather/tree/main/src-lua/plugins/audio-debug",
    actions = {
      ...
      { label = "Pause All", key = "pause-all", icon = "pause", type = "button" },
      {
        ...
        icon = "eye",
        type = "checkbox",
        value = tostring(self.showStopped),
      },
      ...
      -- Effects card
      {
        label = "Effects Supported",
        key = "effectsSupported",
        icon = "sparkles",
        type = "input",
      ...
      {
        label = "Max Source Effects",
        key = "maxSourceEffects",
