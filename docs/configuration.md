...
| `permissions`              | `string[]` or `"all"` | `"all"`             | Allowed plugin permission tokens. Plugins requesting undeclared permissions log a warning at load time. Pass `"all"` to skip checking. |
