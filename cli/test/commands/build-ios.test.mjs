...
`,
  ...
  assert.ok(record.argv.includes('ARCHS=x86_64'));
  assert.ok(record.argv.includes('ONLY_ACTIVE_ARCH=NO'));
...
`,
  ...
  assert.equal(loveEntries.has('feather/core/debug_overlay.lua'), false);
